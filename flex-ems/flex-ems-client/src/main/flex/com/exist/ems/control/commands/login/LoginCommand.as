	...
	public class LoginCommand extends BaseEmsCommand
	{
		...
		override public function result(data:Object):void
		{
			if(data.result != null)
			{
				...
				Application.application.dispatchEvent(new Event(ConstantEvents.LOGIN_SUCCESS,false ,false));
			}
			else
			{
				//Alert.show("Username or Password is not valid","Invalid Credentials");
				Application.application.dispatchEvent(new Event(ConstantEvents.LOGIN_FAILED,false,false));
			}
		}
