package com.exist.ems.control.commands.timecard
{
	...
	public class TimeInCommand extends BaseEmsCommand
	{
		private var timeCardService:TimeCardService;
		
		public function TimeInCommand()
		{
		...
		override protected function callDelegate():void
		{
			...
			timeCardDelegate.timeCardIN(UserData.getInstance().empCode);
		}
		
		override public function result(data:Object):void
		{
			Alert.show("Time In Successful");
